...
namespace Mask.Repository
{
    public class EfRepository<TEntity, TPrimaryKey> : IRepository<TEntity, TPrimaryKey> where TEntity : BaseEntity<TPrimaryKey>
    {
        ...
        public async CTask.Task Add(TEntity entity)
        {
            await Table.AddAsync(entity);
        }

        public async CTask.Task Update(TEntity entity)
        {
            _dbContext.Entry(entity).State = EntityState.Modified;
        }

        public async CTask.Task Delete(TEntity entity)
        {
            _dbContext.Entry(entity).State = EntityState.Deleted;
        }

        public async CTask.Task DeleteWhere(Expression<Func<TEntity, bool>> predicate)
        {
        ...
        public async CTask.Task Commit(CancellationToken cancellationToken = new CancellationToken())
        {
